                ...
                <AccordionContent className="px-6 pb-6 pt-4 bg-gradient-to-b from-gray-50/50 to-white">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-700 leading-relaxed text-justify">
                      ...
                      These words perfectly capture India—a land where
                      everything converges. From ancient invasions to
                      magnificent Maharajas, from enlightened saints to mystical
                      enchanters, and the glorious myths of Gods with over 1000
                      scriptures written about them. The beauty unfolds in
                      endlessly wonderful ways.
                    </p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <p className="text-gray-700">
                        ...
                        seamlessly blends tradition with innovation, boasting
                        the highest numbers of IT professionals, doctors,
                        scientists, researchers, and Nobel laureates.
                      </p>
                    </div>
                    ...
                    <div className="text-center border-t pt-6">
                      ...
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600">
                          Visit our website for affordable airfares and
