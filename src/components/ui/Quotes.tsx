...
function Quotes() {
  return (
    <>
      <div className="flex  flex-col-reverse rounded-2xl h-60 items-center justify-center overflow-hidden p-2 ">
        <div className="w-full flex">
          <motion.img
            src="https://res.cloudinary.com/desslvu1w/image/upload/v1767253392/Pngtree_blue_and_white_airplane_vector_21115229_alc0cc.png"
            initial={{ x: -100 }}
            animate={{ x: 800 }}
